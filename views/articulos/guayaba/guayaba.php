...
<head>
    ...
    <link rel="stylesheet" href="/views/articulos/guayaba/guayaba.css" />
...
<body>
    ...
    <div class="principal">
        <div>
            <img src="public/img/guayaba.jpeg" alt="guayaba" width="900px" height="600px">
        </div>
        <div>
            ...
            <div style="padding-top: 2rem; padding-bottom: 1rem;">
                <h3>La guayaba contiene mucha agua y pocas calorías, es rica en vitamina A, E, D12 y especialmente en vitamina C, incluso más que los cítricos. También es rica en hierro, cobre, calcio, magnesio, potasio, manganeso y fósforo.</h3>
            </div>
            <hr>
    ...
    <script src="/views/articulos/guayaba/guayaba.js"></script>
