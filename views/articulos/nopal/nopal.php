...
<head>
    ...
    <link rel="stylesheet" href="/views/articulos/nopal/nopal.css" />
...
<body>
    ...
    <div class="principal">
        <div>
            <img src="public/img/nopal.jpeg" alt="miel" width="900px">
        </div>
        <div>
            ...
            <div style="padding-top: 2rem; padding-bottom: 1rem;">
                <h3>Contiene vitaminas A, complejo B, C, minerales como calcio, magnesio, sodio, potasio, hierro y fibras en lignina, celulosa, hemicelulosa, pectina, y mucílagos que, en conjunto con los 17 aminoácidos, ayudan a eliminar toxinas provocadas por el alcohol y el humo del cigarro.</h3>
            </div>
            <hr>
    ...
    <div class="productos">
        ...
        <div class="producto">
            <a href="/nuez"><img src="/public/img/nuez2.jpeg" alt="nuez" width="200px"></a>
            <div>
        ...
        <div class="producto">
            <a href="/huevo"><img src="/public/img/huevos2.webp" alt="miel" width="200px" height="135px"></a>
            <div>
                <h3>Huevo</h3>
        ...
        <div class="producto">
            <a href="/guayaba"><img src="/public/img/guayaba.jpeg" alt="guayaba" width="200px" height="135px"></a>
            <div>
                <h3>Guayaba</h3>
                <h3>$<?php echo $PrecioGuayaba; ?></h3>
            </div>
        </div>
