...
<head>
    ...
    <link rel="stylesheet" href="/views/articulos/maracuya/maracuya.css" />
...
<body>
    ...
    <div class="principal">
        <div>
            <img src="public/img/maracuya.avif" alt="maracuya" width="900px" height="600px">
        </div>
        <div>
            <div style="padding-bottom: 2rem;">
                <h1>Pulpa de Maracuya</h1>
            </div>
            <hr>
            ...
            <div style="padding-top: 2rem; padding-bottom: 1rem;">
                <h3>Reduce el riesgo de enfermedades como las degenerativas, las cardiovasculares e algunos estudios apuntan que puede minimizar el riesgo de padecer un cáncer.</h3>
            </div>
            <hr>
    ...
    <script src="/views/articulos/maracuya/maracuya.js"></script>
