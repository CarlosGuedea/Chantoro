...
$consultaExistencia = "SELECT Stock FROM Productos WHERE ProductoID = :id_producto";
...
if ($resultadoExistencia) {
    ...
    $existenciaActual = $resultadoExistencia["Stock"];
    $nuevaExistencia = $existenciaActual + $cantidadResurtir;

    // Actualiza la existencia del producto
    $consultaActualizar = "UPDATE Productos SET Stock = :nueva_existencia WHERE ProductoID = :id_producto";
